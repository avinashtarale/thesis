...
SIMULATION_TIME=1 #Change to 81 seconds to simulate 1000 sidelink periods of 80 ms
PSCCH_RB_M=22 
MCS=10
...
MAX_UES_PER_SECTOR=15 #33 used for evaluations
...
bash ./pscch_error_stats.sh $ver $STARTRUN $MAXRUNS & # PSCCH collisions and subframe overlaps
